...
class Shared::LengthLimitedString
  extend ::T::Private::Methods::MethodHooks
  extend ::T::Private::Methods::SingletonMethodHooks
end
...
class SprintBacklogQuery::SprintBacklogItemStruct
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end
...
class TeamMemberQuery::TeamMemberStruct
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end

class TeamQuery::Member
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end

class TeamQuery::Team
  RUBYGEMS_ACTIVATION_MONITOR = ::T.let(nil, ::T.untyped)
end
